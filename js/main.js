...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine(
        "manikgarg06@about-me:~$ " + command.innerHTML,
        "no-animation",
        0
      );
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "projects":
      ...
      break;
    case "experiences":
      loopLines(experiences, "color2 margin", 80);
      break;
    case "resume":
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="mailto:manikgarg06@gmail.com">manikgarg06@gmail.com</a>...',
        "color2",
        80
      );
      newTab(email);
